...
| format                | format of the displayed value in the input box                                                        | string                                             | see [date formats](/component/date-picker#date-formats)                  | YYYY-MM-DD  |
...
| value-format          | optional, format of binding value. If not specified, the binding value will be a Date object          | string                                             | see [date formats](/component/date-picker#date-formats)                  | —           |
